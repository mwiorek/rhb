...
\begin{figure}[!h]
\centering
  \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{logo/smdistriktstor}
  \caption{A De svenska distrikten}
  \label{fig:distriktskata}
\end{figure}
...
\subsection{Q-koder}
I tabellen listas några av de vanligast förekommande Q-koderna på amatörradiobanden. Det finns förstås många fler koder men detta anses som de vanligaste.
\begin{longtable}{ll}
