...
På engelska används i stället be\-nämn\-ing\-ar\-na RF {\it för radio
...
Kallas även SRBR för {\it Short Range Business Radio}.  Den traditionella
...
För användning av marin VHF krävs tillstånd efter att man genomgått en kurs och
klarat en examinering för ett kompetensbevis. All tillståndshantering sker via
PTS hemsida. SRC betyder {\textit{short range communication }till skillnad från
marin HF/MF som benämns som LRC, {\textit long range communication}.
...
\subsection{Förändringar i kanaltilldelningen}

Det finns ett nytt system i drift som kallas VDES som står för VHF Data Exchange
System och är nästa generation av det marina kommunikationssystemet AIS
(Automatic Identification System). Det är ett system för tvåvägskommunikation
som använder sig av VHF-bandet för bättre datautbyte mellan fartyg,
landstationer och satelliter vilket ger mer bandbredd och förbättrar säkerheten
till sjöss.

Systemet gör anspråk på 6 st frekvenser som tidigare används för telefoni och
dessa är kanalerna 24--26 samt kanalerna 84--86. Detta har medfört ett antal
ändringar i kanalplanen för Stockholm Radio från tidigare så det är viktigt att
uppdatera frekvenstabellerna. Förändringarna gjordes successivt under 2022 utmed
sveriges kuster och inre territorialvatten.

\subsection{Kanalerna 75 och 76}

Dessa två kanaler används även för AIS och talad trafik bör undvikas på dem, de
ligger också frekvensmässigt nära kanal 16 och överhörning är en risk särskilt
vid högre sändareffekter. Därför är rekommendationen att inte sända med mer än
1\,W på dessa frekvenser när man sänder telefoni.
...
\section{Flyg HF}
\todo{Flyg HF}
HN = natt, HJ = dagtid, H24 alltid. Primära frekvenser markerade med *.

\begin{table}[H]
\centering
\begin{tabular}{llrrr}
	\textbf{Område} & \textbf{Kod} & \textbf{HN} & \textbf{H24} & \textbf{HJ} \\ \hline
	Nordatlanten    & NAT          &        2872 &         5598 &      *10051 \\
	                &              &        2889 &         5616 &       11279 \\
	                &              &        2962 &         5649 &       11309 \\
	                &              &        2971 &        *6604 &       11336 \\
	                &              &        3016 &         6622 &      *13270 \\
	´               &              &        3476 &         6628 &       13291 \\
	                ...
	                &              &             &         8891 &             \\
	                &              &             &         8906 &             \\ \hline
	Europa          & EUR          &       *3413 &        *5505 &       10084 \\
	                &              &        3479 &         5661 &      *13264 \\
	                &              &             &         6598 &       13288 \\
	                &              &             &        *8957 &       17961 \\ \hline
	                &              &             &              &
\end{tabular}
\caption{Flygets frekvenser på HF}
\end{table}
...
\section{Amatörradiofrekvenser VHF och uppåt}
