...
min.''. Enstaka gånger kanske man behöver förklara något lite längre men gör
det till en vana att lämna luckor så ofta som möjligt.
...
Polisen har tidigare använt signaler i serien SHA plus fyra siffror, detta är
...
\begin{tabular}{ll}
	SM & Amatörradiosignal utdelad av PTS (nya huvudsignaler tilldelas ej i serien)$^1$                  \\
	...
	SL & Militära amatörradiostationers signaler (som regel två- eller treställiga efter distriktsiffran)
\end{tabular}

$^1$ Specialsignaler kan fortfarande tilldelas i serien men inga nya huvudsignaler utdelas
...
Specialsignaler förekommer inom hela den svenska serien SA--SM samt
även 7S och 8S. Ansökan om sådan specialsignal görs hos SSA och dessa
används ofta för särskilda event eller av individer för
contestsignaler då det är populärt med signaler som är korta och som
gör sig bra på både telefoni och telegrafi.
...
Martin Noll Urban Erik Ivar streck Tre Mobil'') för att påvisa att man
...
\begin{tabular}{llll}
	...
	Kalle   & \MKalle   &                       &                \\
	Ludvig  & \MLudvig  & É (e-accent)          & \Meaccent      \\
	Martin  & \MMartin  & ch (Charlie)          & \Mch           \\
	Niklas  & \MNiklas  & ü (übel)              & \Mubel         \\
	Olof    & \MOlof    &                       &                \\
	Petter  & \MPetter  & Stop (punkt)          & \MSTOP         \\
	Quintus & \MQvintus & Kommatecken           & \MKomma        \\
	Rudolf  & \MRudolf  & Frågetecken (?)       & \MFragetecken  \\
	Sigurd  & \MSigurd  & Bråktecken (/)        & \MBraktecken   \\
	Tore    & \MTore    & Bindestreck (--)      & \MBindestreck  \\
	Urban   & \MUrban   & Sluttecken (+)        & \MSluttecken   \\
	Viktor  & \MViktor  &                       &                \\
	Wilhelm & \MWilhelm & PROCEDURTECKEN        &                \\
	Xerxes  & \MXerxes  & Repetera              & \MRepetera     \\
	Yngve   & \MYngve   & Väntatecken           & \MVanta        \\
	Zäta    & \MZata    & Avslutningstecken (+) & \MAvslutning   \\
	Åke     & \MAke     & Åtskillnadstecken (=) & \MAtskillnad   \\
	Ärlig   & \MArlig   & Felskrivningstecken   & \MFelskrivning \\
	Östen   & \MOsten   &                       &                \\
\end{tabular}
\normalsize
