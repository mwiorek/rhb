...
störningar och att bli störd, filter och antenner liksom även elsäkerhet.

Det andra provet är ett prov över reglementet som är tillämpligt, både lagar
och författningar som reglerar amatörradio men även saker som mer praktiska
som exempelvis bokstaveringsalfabetet och Q-koder mm.
...
\subsection{Restriktioner för instegscertifikat jämfört med HAREC}
...
så har dessa system numera gått samman i {\it RAKEL} (radiokommunikation för
...
700~MHz-bandet. Detta nya nät kallas ibland för {\it SWEN} (Swedish emergency
