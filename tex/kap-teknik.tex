...
\subsection{Anntenvinst och effekter i ERP och EIRP}
...
DTMF används för in-band signallering, dvs signallering i det hörbara området. Detta används bland annat av vissa repeatrar och länkar för styrning av olika funktioner. DTMF är en förkortning för ''Dual Tone Multi Frequency'' och som synes används två frekvenser för varje ton. Det finns 4 st höga och 4 st låga frekvenser och dessa kombineras enligt tabellen nedan för att producera 16 olika unika kombinationer.

Detta används 10 st för siffrorna 0--9 samt asterisk (*) och brädstapel (\#) liksom fyra bokstäver A--F.
