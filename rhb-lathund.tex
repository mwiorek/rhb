...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\TitleText}{Radiohandbokens lathund}
...
\newcommand{\DokVersion}{12:e utgåvan RC1}	% Utgåva i fortsättningen
\newcommand{\DokYear}{2025}
\newcommand{\DokumentDatum}{\today}
%\newcommand{\ISBN}{978-91-531-4764-0}
...
]{hyperref}   % Hyperref möjliggör länkar utanför dokumentet
...
\input{tex/kap-lathund}        % Lathunden och inget annat
